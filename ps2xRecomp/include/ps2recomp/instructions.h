...
namespace ps2recomp
{
    ...
    // VU0 integer/control register numbers (used with CFC2/CTC2).
    // CCR[2,0..15] are VI00..VI15. The values below are the actual
    // five-bit `id` values for the control registers in CCR[2,16..31].
